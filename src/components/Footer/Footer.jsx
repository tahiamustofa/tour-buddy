...
export const Footer = () => {
    ...
    return (
        <div className="relative mt-16 bg-gradient-to-br from-[#13253F] to-purple-950">
            <svg
                ...
                <div className="grid lg:gap-3 gap-8 mb-8 sm:grid-cols-2 lg:grid-cols-4 justify-center">
                    <div className="md:max-w-sm ">
                        ...
                        >
                            ...
                            <span className="ml-2 md:text-lg text-base font-bold tracking-wide text-white uppercase">
                                tour buddy
                            </span>
                        </a>
                        <div className="mt-4">
